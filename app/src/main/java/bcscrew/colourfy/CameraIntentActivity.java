...
public class CameraIntentActivity extends AppCompatActivity {
    ...
    private TextView textSource, textInfo;
        ...
        mPhotoCapturedImageView.setOnTouchListener(new View.OnTouchListener() {
            ...
            private int getPictureColor(ImageView view, Bitmap bm, int x, int y) {
                if (x<0 || y < 0 || x > view.getWidth() || y > view.getHeight()) {
                    ...
                    textSource.setText(getColorNameFromHex(bm.getPixel(projectedX, projectedY)));

                    int colour = bm.getPixel(projectedX, projectedY);
                    ...
                    getColorNameFromHex(bm.getPixel(projectedX, projectedY));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == ACTIVITY_START_CAMERA_APP && resultCode == RESULT_OK) {
            ...
            bitmapMaster = photoCapturedBitmap;
